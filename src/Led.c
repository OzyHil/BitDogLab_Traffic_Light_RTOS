...
const led_color GREEN = {.red = 0, .green = 72, .blue = 0};
const led_color YELLOW = {.red = 108, .green = 54, .blue = 0};
const led_color RED = {.red = 108, .green = 0, .blue = 0};
const led_color RED_DIM = {.red = 2, .green = 0, .blue = 0};
const led_color YELLOW_DIM = {.red = 2, .green = 1, .blue = 0};
const led_color GREEN_DIM = {.red = 0, .green = 2, .blue = 0};
